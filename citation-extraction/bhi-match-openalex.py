...
def enrich_bhi_publications(bhi_publications):
    ...
    print("PROCESS: Start enriching BHI publications with OpenAlex data...")
...
print("PROCESS: Loading BHI publications...")
bhi_publications = load_bhi_publications(bhi_publications_path)
print("LOG: Loaded {} BHI publications.".format(len(bhi_publications)))

enriched_publications = enrich_bhi_publications(bhi_publications)
